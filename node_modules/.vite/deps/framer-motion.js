...
function useVisualElement(Component3, visualState, props, createVisualElement2, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react7.useRef)(Boolean(optimisedAppearId) && !window.MotionHandoffIsComplete && ((_a = window.MotionHasOptimisedAnimation) === null || _a === void 0 ? void 0 : _a.call(window, optimisedAppearId)));
...
function usePresence() {
  ...
  const safeToRemove = (0, import_react17.useCallback)(() => onExitComplete && onExitComplete(id4), [id4, onExitComplete]);
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  const context = (0, import_react24.useMemo)(() => config, [JSON.stringify(config.transition), config.transformPagePoint, config.reducedMotion]);
...
function useSpring(source, config = {}) {
  ...
  const latestValue = (0, import_react34.useRef)(value.get());
  const latestSetter = (0, import_react34.useRef)(() => {
  });
...
function useUnmountEffect(callback) {
  return (0, import_react40.useEffect)(() => () => callback(), []);
}
...
function useInView(ref, { root, margin, amount, once = false } = {}) {
  const [isInView, setInView] = (0, import_react42.useState)(false);
...
function useInstantTransition() {
  ...
  const unlockOnFrameRef = (0, import_react44.useRef)();
